...
export default function KitCard({ kit, priority = false }: KitCardProps) {
  ...
  const prefix = kit.grade === "HG" && kit.subline ? kit.subline : kit.grade;
  const displayTitle = `${prefix} ${kit.model_number} ${kit.model_name}`;
  ...
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white shadow-md transition-all duration-300 hover:shadow-xl dark:border-gray-700 dark:bg-gray-800 hover:scale-105">
      {/* Image Container */}
      <div
        className="relative h-64 w-full overflow-hidden bg-gray-100 dark:bg-gray-700 sm:h-72 cursor-pointer"
      ...
      <div className="flex flex-1 flex-col justify-between p-4">
        ...
        <div className="flex-1">
          ...
          <h3 className="mt-1 text-sm font-semibold text-gray-900 line-clamp-2 dark:text-white">
            {kit.model_name}
          </h3>
